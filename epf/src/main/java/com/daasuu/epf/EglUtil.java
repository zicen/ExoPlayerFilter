...
public class EglUtil {
    ...
    public static void setupSampler(final int target, final int mag, final int min) {
        ...
        GLES20.glTexParameterf(target, GL_TEXTURE_MAG_FILTER, GL_LINEAR_MIPMAP_LINEAR);
    ...
    public static int loadTexture(final Bitmap img, final int usedTexId, final boolean recycle) {
        ...
        if (usedTexId == NO_TEXTURE) {
            ...
            GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
            GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
